 ...
 */
final class Version20240723093028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emploi CHANGE field field JSON NOT NULL COMMENT \'(DC2Type:json)\', CHANGE logo logo VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE emploi CHANGE field field VARCHAR(255) NOT NULL, CHANGE logo logo VARCHAR(255) NOT NULL');
